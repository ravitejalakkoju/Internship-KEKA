window.onload = function () {
    ...
    var formValidation = function () {
        ['input', 'change'].forEach(function (e) { return document.getElementById('name').addEventListener(e, function () {
            document.getElementById('nameRequired').style.display = 'none';
        }); });
        ['input', 'change'].forEach(function (e) { return document.getElementById('email').addEventListener(e, function () {
        ...
        ['input', 'change'].forEach(function (e) { return document.getElementById('mobileNum').addEventListener(e, function () {
        ...
        ['input', 'change'].forEach(function (e) { return document.getElementById('landline').addEventListener(e, function () {
            document.getElementById('landlineRequired').style.display = 'none';
        }); });
        ['input', 'change'].forEach(function (e) { return document.getElementById('website').addEventListener(e, function () {
        ...
        ['input', 'change'].forEach(function (e) { return document.getElementById('address').addEventListener(e, function () {
...
var Employees = /** @class */ (function () {
    ...
    Employees.prototype.emailCheck = function (email, eid) {
        var returnValue = true;
    ...
    Employees.prototype.mobileCheck = function (mobile, eid) {
        var returnValue = true;
        this.employees.forEach(function (em) {
    ...
    Employees.prototype.sortEmployees = function (eid) {
    ...
    Employees.prototype.add = function (employee) {
        var emailDuplicate = this.emailCheck(employee.getEmail(), employee.getEid());
        var mobileDuplicate = this.mobileCheck(employee.getMobile(), employee.getEid());
    ...
    Employees.prototype.update = function (eid, name, email, mobile, landline, website, address) {
        var emailDuplicate = this.emailCheck(email, eid);
        var mobileDuplicate = this.mobileCheck(mobile, eid);
        if (emailDuplicate && mobileDuplicate) {
            this.employees.forEach(function (el) {
                if (el.getEid() === eid) {
