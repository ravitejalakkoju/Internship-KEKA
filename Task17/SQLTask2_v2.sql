...
select Products.ProductID, Products.ProductName, CheapProduct.UnitPrice from Products
inner join (
select OrderDetails.ProductID, OrderDetails.UnitPrice from OrderDetails
inner join Orders on OrderDetails.OrderID = Orders.OrderID and year(Orders.OrderDate) = '1997' and month(Orders.OrderDate) = '10' and day(Orders.OrderDate) between '8' and '15'
inner join (select min(OrderDetails.UnitPrice) as MinUnitPrice from OrderDetails
inner join Orders on OrderDetails.OrderID = Orders.OrderID and year(Orders.OrderDate) = '1997' and month(Orders.OrderDate) = '10' and day(Orders.OrderDate) between '8' and '15') MinPriceProduct 
on OrderDetails.UnitPrice = MinPriceProduct.MinUnitPrice) CheapProduct
on Products.ProductID = CheapProduct.ProductID
union
select Products.ProductID, Products.ProductName, CheapProduct.UnitPrice from Products
inner join (
select OrderDetails.ProductID, OrderDetails.UnitPrice from OrderDetails
...
inner join Orders on OrderDetails.OrderID = Orders.OrderID and year(Orders.OrderDate) = '1997' and month(Orders.OrderDate) = '10' and day(Orders.OrderDate) between '8' and '15') MaxPriceProduct 
on OrderDetails.UnitPrice = MaxPriceProduct.MaxUnitPrice) CheapProduct
on Products.ProductID = CheapProduct.ProductID
